...
void MagicStick::attack(Player * player)
{
	...
	projectile->init("lalaStickBullet", "L_Effect_lalaStick", bulletSize, bulletRect, Vector2(0,0), Vector2(30 * 10, 30 * 10), 3, angleRadian, true, true, 10, true, false, false, false);	// 함수 인수가 바뀌었어요 >> 확인해주세요	
