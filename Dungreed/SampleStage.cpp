...
void SampleStage::render()
{
	...
	CAMERA->render(IMAGE_MANAGER->findImage("Town_BGL"), Vector2(WINSIZEX / 2, WINSIZEY / 2));
	IMAGE_MANAGER->findImage("Town_BG")->setScale(5);
	CAMERA->render(IMAGE_MANAGER->findImage("Town_BG"), Vector2(WINSIZEX / 2, WINSIZEY / 2+200));
	IMAGE_MANAGER->findImage("Town_BG2")->setScale(5);
	CAMERA->render(IMAGE_MANAGER->findImage("Town_BG2"), Vector2(WINSIZEX / 2, WINSIZEY / 2+200));
