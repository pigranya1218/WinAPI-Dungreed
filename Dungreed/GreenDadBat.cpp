...
void GreenDadBat::attack(Player * player)
{
	...
	projectile->init("BabyBatBulletAt", "DadBatBulletFX", Vector2(70, 70), Vector2(190, 190), Vector2(190, 190), Vector2(500, 500), 1, angleRadian, true, true, 20, false, false, true, false);	// 함수 인수가 바뀌었어요 >> 확인해주세요
