...
void GreenBat::attack(Player * player)
{
	...
	projectile->init("BabyBatBulletAt", "BabyBatBulletFx", Vector2(110, 110), Vector2(40, 40),  Vector2(110, 110), Vector2(500, 500),  1, angleRadian, true, true, 20, false, false, true, false);	// 함수 인수가 바뀌었어요 >> 확인해주세요
